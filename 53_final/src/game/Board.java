...
public class Board {
	...
	public Board() {
		...
		boardArray[9] = new Street("Allégade", 2400, 2, 150, 800, 2000, 6000, 9000, 12000);
		boardArray[10] = new VisitJail(); // Fixet
		boardArray[11] = new Street("Frederiksberg Allé", 2800, 3, 200, 1000, 3000, 9000, 12500, 15000);
		boardArray[12] = new Brewery("Tuborg", 3000, int rent); //TODO rent til bryggerierne?
		boardArray[13] = new Street("Bülowsvej", 2800, 3, 200, 1000, 3000, 9000, 12500, 15000);
		...
		boardArray[23] = new Street("Østerbrogade", 4400, 5, 350, 1800, 5000, 14000, 17500, 21000);
		boardArray[24] = new Street("Grønningen", 4800, 5, 400, 2000, 6000, 15000, 18500, 22000);
		...
		boardArray[29] = new Street("Østergade", 5600, 6, 500, 2400, 7200, 17000, 20500, 24000);
		...
		boardArray[39] = new Street("Rådhuspladsen", 8000, 8, 1000, 40000, 12000, 28000, 34000, 40000);
	}
