...
public class Board {
	...
	public Board() {
		...
		boardArray[1] = new Street("R&oslash;dovrevej", 1200, 1, 50, 250, 750, 2250, 4000, 6000, 1000, 2000);
		...
		boardArray[9] = new Street("Allegade", 2400, 2, 150, 800, 2000, 6000, 9000, 12000, 1000, 2000);
		boardArray[10] = new VisitJail("F&aelig;ngsel"); 
		boardArray[11] = new Street("Frederiksberg Alle", 2800, 3, 200, 1000, 3000, 9000, 12500, 15000, 1000, 2000);
		boardArray[12] = new Brewery("Tuborg", 3000, 100);
		boardArray[13] = new Street("B&uuml;lowsvej", 2800, 3, 200, 1000, 3000, 9000, 12500, 15000, 1000, 2000);
		...
		boardArray[23] = new Street("&Oslash;sterbrogade", 4400, 5, 350, 1800, 5000, 14000, 17500, 21000, 1000, 2000);
		boardArray[24] = new Street("Gr&oslash;nningen", 4800, 5, 400, 2000, 6000, 15000, 18500, 22000, 1000, 2000);
		...
		boardArray[29] = new Street("&Oslash;stergade", 5600, 6, 500, 2400, 7200, 17000, 20500, 24000, 1000, 2000);
		...
		boardArray[39] = new Street("R&aring;dhuspladsen", 8000, 8, 1000, 40000, 12000, 28000, 34000, 40000, 1000, 2000);
	}
