...
public class GameController {
	...
	// F.EKS.:
	// FORKERT	String a = "√Öen er lang og √¶llinger sv√∏mmer i den";
	...
	public GameController() {
		...
		do {
			...
			if((turn.getIndex(turn.getCurrent()) == 0) && (player[turn.getCurrent()].getJailed() == false)) {
				// TODO Kristin check den her metode ud til valg! den returnere en String af den knap man har trykket pÂ
//				String choices = GUI.getUserButtonPressed("Det er din tur", "Kast med terning", "byg hus / hotel","sÊlg grund" );
